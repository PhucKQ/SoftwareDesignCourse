...
namespace AromaShop.Data.Migrations
{
    ...
    [Migration("20230605035022_fixOrderDetailTableName_andAddSessionIdAttribute")]
    partial class fixOrderDetailTableName_andAddSessionIdAttribute
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AromaShop.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AromaShop.Models.User", b =>
                {
            ...
            modelBuilder.Entity("AromaShop.Models.Blog", b =>
                {
                    b.HasOne("AromaShop.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("AromaShop.Models.Comment", b =>
                {
                    b.HasOne("AromaShop.Models.Blog", "Blog")
                        .WithMany("Comments")
                        .HasForeignKey("BlogId");

                    b.HasOne("AromaShop.Models.Comment", "ParentComment")
                        .WithMany()
            ...
            modelBuilder.Entity("AromaShop.Models.OrderDetail", b =>
                {
                    b.HasOne("AromaShop.Models.OrderHeader", "OrderHeader")
                        .WithMany()
